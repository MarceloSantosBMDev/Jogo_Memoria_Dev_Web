document.addEventListener("DOMContentLoaded", () => {
	...
	const dificuldades = [
		{ name: "Iniciais", size: "2x2", gamePage: "Pages/gameboard.html" },
		{ name: "Raros", size: "4x4", gamePage: "Pages/gameboard.html" },
		{ name: "Lendários", size: "6x6", gamePage: "Pages/gameboard.html" },
		{ name: "Míticos", size: "8x8", gamePage: "Pages/gameboard.html" },
	];
